(() => {
  ...
  function ae({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function o() {
      e.keyboard.enabled || (T(n).on("keydown", a), (e.keyboard.enabled = !0));
    }
    function l() {
      e.keyboard.enabled && (T(n).off("keydown", a), (e.keyboard.enabled = !1));
    }
  ...
  function oe({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function p(t) {
      return (
        ...
        !(
          ...
          E() - o < e.params.mousewheel.thresholdTime
        ) &&
        ((t.delta >= 6 && E() - o < 60) ||
          (t.direction < 0
    ...
    function u(t) {
      ...
      if (
        ...
        !e.mouseEntered && !d[0].contains(s.target) && !o.releaseOnEdges)
      )
        return !0;
      ...
      if (0 === c) return !0;
      o.invert && (c = -c);
      let m = e.getTranslate() + c * o.sensitivity;
      if (
        ...
        const t = { time: E(), delta: Math.abs(c), direction: Math.sign(c) },
          n =
            a &&
            t.time < a.time + 500 &&
            t.delta <= a.delta &&
  ...
  window.addEventListener("load", function (e) {
    ce(),
      document.querySelector(".slider-products__slider") &&
        new re(".slider-products__slider", {
          modules: [le, de, oe, ae],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          autoHeight: !0,
          speed: 900,
          mousewheel: { sensitivity: 1, invert: !0 },
          ...
          breakpoints: {
            ...
            768: { slidesPerView: 2, spaceBetween: 20, keyboard: !1 },
      ...
      document.querySelector(".testimonials__slider") &&
        new re(".testimonials__slider", {
          ...
          breakpoints: {
            ...
            950: { slidesPerView: 3, mousewheel: !0, spaceBetween: 30 },
  ...
  setTimeout(() => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const e = document.querySelectorAll(".menu__btn"),
        t = document.querySelectorAll(".dropdown");
      e.forEach((e) => {
        e.addEventListener("click", (e) => {
          let s = e.currentTarget,
            i = s.closest(".menu__item").querySelector(".dropdown");
          t.forEach((e) => {
            e !== i && e.classList.remove("dropdown_active");
          }),
            s.classList.toggle("menu__btn_active"),
            i.classList.toggle("dropdown_active");
        });
      }),
        document.addEventListener("click", (i) => {
          i.target.closest(".menu__item") ||
            t.forEach((e) => {
              e.classList.remove("dropdown_active");
            }),
            i.target.closest(".menu__btn") ||
              e.forEach((e) => {
                e.classList.remove("menu__btn_active");
              }),
            i.target.closest(".box-dot__button") ||
              i.target.closest(".box-dot__tooltip") ||
              s.forEach((e) => {
                e.classList.remove("box-dot__button_active");
              });
        });
      const s = document.querySelectorAll(".box-dot__button");
      s &&
        s.forEach((e) => {
          e.addEventListener("click", (e) => {
            s.forEach((e) => {
              ...
              e.currentTarget.classList.toggle("box-dot__button_active");
          });
        }),
